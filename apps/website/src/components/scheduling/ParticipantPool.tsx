...
export default function ParticipantPool({
  ...
  useEffect(() => {
    ...
    try {
      ...
      locksSource = createDraftLocksEventSource(eventId);
      ...
      return allParticipants.filter((participant) => {
        try {
          ...
          if (filters.availability !== 'all') {
            ...
            if (filters.availability === 'locked' && !isLocked && !isSelected) {
              return false;
            }
          }
  ...
  }, [helperParticipants, proggers, filters, draftLocks, selectedParticipants]);
            ...
            <div className="space-y-0 divide-y divide-gray-200">
              {Array.from({ length: 5 }, (_, i) => (
                <div
                  ...
                  className="h-20 bg-gray-50 flex items-center p-4"
                >
            ...
            {filteredParticipants.map((participant) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={`w-full text-left p-4 transition-colors h-20 flex items-center ${
                    isPending
                          ...
                          (participant as any).availableJobs ? (
                            <div className="mt-1 overflow-hidden">
                              <div className="flex flex-wrap gap-1 max-h-6 overflow-hidden">
                                ...
                                {(participant as any).availableJobs.length >
                                  4 && (
