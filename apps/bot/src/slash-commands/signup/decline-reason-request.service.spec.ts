...
describe('DeclineReasonRequestService', () => {
  ...
  describe('updateSignupWithDeclineReason', () => {
    it('does not record the reason and notifies the reviewer when the signup has left the declined round', async () => {
  ...
  describe('dispatchDeclineReasonEvent', () => {
    it('does not publish the event and notifies the reviewer when the signup changed state', async () => {
      ...
      await service['dispatchDeclineReasonEvent'](
        signup,
        reviewer,
        reviewMessage,
        'lacks proof',
  ...
  describe('handleReasonSelection reply', () => {
    it('replies that the decline reason was not recorded when the signup is stale', async () => {
