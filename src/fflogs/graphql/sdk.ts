...
export const CharacterPageRankingMetricType = {
...
export type CharacterPageRankingMetricType = typeof CharacterPageRankingMetricType[keyof typeof CharacterPageRankingMetricType];
...
export type Query = {
  ...
  readonly reportComponentData: Maybe<ReportComponentData>;
  ...
  readonly systemReportComponentData: Maybe<ReportComponentData>;
...
export type ReportComponent = {
  readonly __typename: 'ReportComponent';
  ...
  readonly deletionProtected: Scalars['Boolean']['output'];
  /** Evaluate a report component against report data, returning the result. */
  readonly evaluate: Maybe<ReportComponentResult>;
...
export type ReportComponentFilter = {
  ...
  readonly actorID: InputMaybe<Scalars['Int']['input']>;
  /**
   ...
   *
   */
  readonly deathCutoff: InputMaybe<Scalars['Int']['input']>;
  ...
  readonly difficulty: InputMaybe<Scalars['Int']['input']>;
  ...
  readonly phase: InputMaybe<Scalars['Int']['input']>;
  /** Filter input events to those within this range. */
  readonly timestampRange: InputMaybe<ReportComponentRangeFilter>;
};

export type ReportComponentMutation = {
  readonly __typename: 'ReportComponentMutation';
  /** Create a new (possibly empty) report component. If successful, the KEY of the new component will be returned. */
  readonly create: Maybe<Scalars['String']['output']>;
...
export type ReportComponentRangeFilter = {
  ...
  readonly endTime: Scalars['Int']['input'];
  /** The report-relative start time, in milliseconds. */
  readonly startTime: Scalars['Int']['input'];
};

export type ReportComponentResult = {
  readonly __typename: 'ReportComponentResult';
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    characterData(variables?: CharacterDataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CharacterDataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CharacterDataQuery>({ document: CharacterDataDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'characterData', 'query', variables);
    },
    encounterRankings(variables?: EncounterRankingsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<EncounterRankingsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<EncounterRankingsQuery>({ document: EncounterRankingsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'encounterRankings', 'query', variables);
    },
    reportData(variables: ReportDataQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ReportDataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ReportDataQuery>({ document: ReportDataDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'reportData', 'query', variables);
    }
  };
}
